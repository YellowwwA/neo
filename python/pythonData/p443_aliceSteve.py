...
wc = WordCloud(background_color='white', mask=alice_mask, max_words=2000, stopwords=mystopwords)
...
wc = WordCloud(background_color='white', mask=alice_color_mask, max_words=2000, stopwords=mystopwords, max_font_size=40, random_state=42)
wc = wc.generate(text)
